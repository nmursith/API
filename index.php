...
<div class="card-payment">
  ...
  <!--                        <li><a href="javascript:void(0);">4000 0000 0000 0002</a></li>
						  ...
						  <li><a href="javascript:void(0);">4032 0370 2480 5539</a></li>
						  <li><a href="javascript:void(0);">4032 0391 0542 2911</a></li>
                      </ul>
                  </div>
              ...
              <li class="vertical">
                  <ul>
                      <li>
                          ...
                          <input type="text" placeholder="MM" maxlength="5" id="expiry_month" name="expiry_month" value="12">
                      </li>
                      <li>
                          <label for="expiry_year">Expiry year</label>
                          <input type="text" placeholder="YYYY" maxlength="5" id="expiry_year" name="expiry_year" value="2021">
                      </li>
                      <li>
              ...
              <li>
                  ...
                  <input type="text" placeholder="Name" id="name_on_card" name="name_on_card" value="Mohamed Nifras">
              </li>
              <li><input type="button" name="card_submit" id="cardSubmitBtn" value="Proceed" class="payment-btn" disabled="true" ></li>
              <p style="color:#EA0075;">Demo on PayPal sandbox accounts.</p>
          </ul>
      </form>
  </div>
